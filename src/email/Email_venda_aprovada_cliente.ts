...
export function Email_venda_aprovada_cliente(email_vendedor:string, email_comprador:string, name_comprador:string, name_vendedor:string, valor:number, titulo:string){
    ...
    <div style="padding: 5% 10%;">
        <h4 style="color: #8C36EE; font-size: 18px;">Parabéns!!!</h4>
        <h4 style="color: #8C36EE; font-size: 14px;">Sua compra foi aprovada.</h4></br>
        <h4 style="color:black; padding-top: 25px;">Descrição da Compra:</h4>
