...
export function Email_venda_canceled_produtor(email_vendedor:string, email_comprador:string, name_comprador:string, name_vendedor:string, valor:number, titulo:string){
